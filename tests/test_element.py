...
def test_elementstr_single():
	element = ElementPointer((0, 0), 10, 0, 10, True)
	...
	estr.elements = ElementPointer((0, 0), len(estr), 0, len(estr), is_constant=True),
...
def test_compress():
	...
	estr.elements = (
		ElementPointer((0, 1), representation_length=11, offset=10, length=1, is_constant=False),
		ElementPointer((0, 2), representation_length=35, offset=0, length=35, is_constant=True),
		ElementPointer((0, 3), representation_length=50, offset=0, length=50, is_constant=True),
		ElementPointer((0, 4), representation_length=37, offset=0, length=37, is_constant=True),
		ElementPointer((0, 5), representation_length=16, offset=0, length=5, is_constant=False),
	)
	...
	assert compressed.elements == (
		ElementPointer((0, 1), representation_length=11, offset=10, length=1, is_constant=False),
		ElementPointer((0, 2), representation_length=35, offset=0, length=35+len(ETC), is_constant=True),
		ElementPointer((0, 4), representation_length=37, offset=0, length=37, is_constant=True),
		ElementPointer((0, 5), representation_length=16, offset=0, length=5, is_constant=False),
	)
