...
def test_all_terminals_present():
	...
	template_element = [
		...
		('{{ name }}', (ElementPointer(path=(0, 1, 1,), representation_length=11, offset=0, length=10, is_constant=False), ElementPointer(path=(0, 1, 1), representation_length=11, offset=10, length=0, is_constant=False),)),
		...
		('{{ name }}', (ElementPointer(path=(0, 5, 1,), representation_length=16, offset=5, length=10, is_constant=False), ElementPointer(path=(0, 5, 1), representation_length=16, offset=15, length=0, is_constant=False),)),
